...
ApplicationWindow {
    id: app
    property string appTitle: "Наукова"
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Behavior on x {
                NumberAnimation {
                    duration: app.durationOfMenuAnimation
